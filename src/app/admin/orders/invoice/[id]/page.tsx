...
type OrderDoc = {
  ...
  invoiceDate?: any | null;  // Timestamp de emisión guardado
};
...
/** ❗️Helper estricto: devuelve null si no se puede parsear (no hace fallback a "ahorita"). */
function toDateOrNullStrict(x: any): Date | null {
  ...
  // String o número (epoch ms/s o ISO)
